...
class MedellinImport implements ToModel, WithHeadingRow
{
    private $headerRow;
    private $headerRows = [];
    ...
    public function model(array $row)
    {
        ...
        try {
            ...
            $potenciaModel = new PotenciaMede();
    ...
    private function saveHeaderRowToDatabase(array $headerRow)
    {
        ...
        foreach ($headerRow as $header) {
            EncabezadoMede::create(['encabezadoMede' => $header]);
        }
