...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("home", compact('users', 'potencias', 'potenciasBuca', 'potenciasCali', 'potenciasMede', 'promPotenciasBuca', 'promPotenciasCali', 'promPotenciasMede', 'promPotencias', 'encabezados', 'ciudades'));
    }
}
