...
@section('title','Lista de Estados Solicitud Vigencia')
@section('style')
<!-- SweetAlert2 -->
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                     ...
                     <a href="{{route('admin.estadovigencias.create')}}" class="btn btn-primary">
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       <td>{{$estadovigencia->id}}</td>
                       <td>{{$estadovigencia->detestadovigencia}}</td>
                       <td class="project-actions text-right">
                           <form action="{{route('admin.estadovigencias.destroy',$estadovigencia)}}" method="POST">
                              @csrf
                               @method('delete')

                               <a class="btn btn-primary btn-sm" href="{{route('admin.estadovigencias.edit', $estadovigencia)}}">Editar</a>
