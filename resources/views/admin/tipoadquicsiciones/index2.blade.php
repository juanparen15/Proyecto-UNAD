...
@section('title','Lista Tipo Adquisicion Contrato')
@section('style')
<!-- SweetAlert2 -->
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    {{--  <h1 class="m-0">Lista Tipo Adquisicion Contrato del sistema</h1>  --}}
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  {{--  <div class="card-tools">
                     ...
                     <a href="{{route('admin.tipoadquicsiciones.create')}}" class="btn btn-primary">
                        Agregar Area
                     </a>
                  </div>  --}}
                </div>
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       <td>{{$requipoai->id}}</td>
                       <td>{{$requipoai->dettipoadquisicion}}</td>
                       
                       {{--  <td>
                           <form action="{{route('admin.tipoadquicsiciones.destroy',$requipoai)}}" method="POST">
                              @csrf
                               @method('delete')

                               <a class="btn btn-primary btn-sm" href="{{route('admin.tipoadquicsiciones.edit', $requipoai)}}">Editar</a>
