...
@section('title','Crear Nuevo Soporte Documental')
@section('style')
<!-- Select2 -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Crear Nuevo Soporte Documental</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('home')}}">Inicio</a></li>
              <li class="breadcrumb-item"><a href="{{route('admin.fuentes.index')}}">Soporte Documental</a></li>
              <li class="breadcrumb-item active">Crear Nuevo Soporte Documental</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('detfuente',null,['class' => 'form-control', 'placeholder' =>'Ingrese el Nombre del Soporte Documental']) !!}
                     @error('detfuente')
