...
@section('title','Lista de Soporte Documental')
@section('style')
<!-- SweetAlert2 -->
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Agregar Soporte Documental</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista de Soporte Documental</h3>
                  <div class="card-tools">

                     <a href="{{route('admin.fuentes.create')}}" class="btn btn-primary">
                        Agregar Soporte Documental
                     </a>
                  </div>
                </div>
                <!-- /.card-header -->
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    <thead>
                     <tr>
                        ...
                        <th>ID</th>
                        <th>NOMBRE DEL SOPORTE DOCUMENTAL</th>
                        <th>ACCIONES</th>
                      </tr>
                    </thead>
                    <tbody>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El Soporte se Actualizo con Exito.'
        })
      });
</script>
@endif
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El Soporte se Creo con Exito.'
        })
      });
</script>
@endif
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'El Soporte se Elimino con Exito.',
        'success'
      )
</script>
@endif
