...
@section('title','Lista Tipo Zonas')
@section('style')
<!-- SweetAlert2 -->
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    {{--  <h1 class="m-0">Lista Tipo Zonas del sistema</h1>  --}}
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  {{--  <div class="card-tools">
                     ...
                     <a href="{{route('tipozonas.create')}}" class="btn btn-primary">
                        Agregar Tipo Zona
                     </a>
                  </div>  --}}
                </div>
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     @foreach ($tipozonas as $tipozona)
                        ...
                        {{--  <td>
                              <form action="{{route('tipozonas.destroy',$tipozona)}}" method="POST">
                                 @csrf
                                 @method('delete')
                                 <a class="btn btn-primary btn-sm" href="{{route('tipozonas.edit', $tipozona)}}">Editar</a>
