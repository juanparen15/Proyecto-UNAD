            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista del Objeto</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista de Objeto</h3>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El objeto se creó con exito.'
        })
      });
</script>
@endif
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El objeto se actualizó con exito.'
        })
      });
</script>
@endif
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'El objeto se elimino con exito.',
        'success'
      )
</script>
@endif
