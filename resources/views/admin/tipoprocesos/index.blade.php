...
@section('title','Lista Tipo Proceso Contratual')
@section('style')
<!-- SweetAlert2 -->
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    {{--  <h1 class="m-0">Lista Tipo Proceso Contratual del sistema</h1>  --}}
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                     ...
                     <a href="{{route('admin.tipoprocesos.create')}}" class="btn btn-primary">
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     @foreach ($tipoprocesos as $tipoproceso)
                        ...
                        <td>{{$tipoproceso->dettipoproceso}}</td>
                        
                        <td>
                              <form action="{{route('admin.tipoprocesos.destroy',$tipoproceso)}}" method="POST">
                                 @csrf
                                 @method('delete')

                                 <a class="btn btn-primary btn-sm" href="{{route('admin.tipoprocesos.edit',$tipoproceso)}}">Editar</a>
