...
var group_Emisora_Bogot_929_MHz = new ol.layer.Group({
    layers: [lyr_Signallevel_0, lyr_Signallevel, lyr_Radioelectricelements_1,],
    title: "Emisora_Bogotá_92.9_MHz"
});

lyr_Signallevel_0.setVisible(true); lyr_Radioelectricelements_1.setVisible(true); lyr_GoogleSatellite_3.setVisible(true);
var layersList = [group_Emisora_Bogot_929_MHz, lyr_GoogleSatellite_3];
