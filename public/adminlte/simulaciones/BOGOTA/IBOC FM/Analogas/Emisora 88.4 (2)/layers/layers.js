...
var lyr_Signallevel_0 = new ol.layer.Vector({
    ...
    interactive: true,
    title: '<img src="styles/legend/Signallevel_0.png" /> Signal level'
});
...
var group_Emisora_Bogot_884_MHz_2 = new ol.layer.Group({
    layers: [lyr_Signallevel_0, lyr_Signallevel, lyr_Radioelectricelements_2,],
    title: "Emisora_Bogotá_88.4_MHz_2"
});

lyr_Radioelectricelements_2.setVisible(true); lyr_GoogleSatellite_3.setVisible(true);
var layersList = [group_Emisora_Bogot_884_MHz_2, lyr_GoogleSatellite_3];
